...
public static class IsoConstants
{
    ...
    [
        ...
        new Fq2(
            Constants.Q,
            new Fq(Constants.Q, BigInteger.Zero),
            new Fq(
                Constants.Q,
    ...
    [
        ...
        new Fq2(
            Constants.Q,
            new Fq(Constants.Q, BigInteger.Parse("0c", NumberStyles.HexNumber)),
            new Fq(
                Constants.Q,
        ...
        new Fq2(Constants.Q, new Fq(Constants.Q, BigInteger.One), new Fq(Constants.Q, BigInteger.Zero)),
    ];
