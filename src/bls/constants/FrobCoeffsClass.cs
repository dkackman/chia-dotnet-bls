...
public static class FrobCoeffsClass
{
    public static readonly IReadOnlyDictionary<string, Fq> FrobCoeffs = new Dictionary<string, Fq>
    {
        ...
        ["6,3,1"] = new Fq2(Constants.Q, new Fq(Constants.Q, 0), new Fq(Constants.Q, 1)),
        ["6,3,2"] = new Fq2(
            Constants.Q,
            new Fq(
                Constants.Q,
        ...
        ["12,1,1"] = new Fq6(
            ...
            new Fq2(Constants.Q, new Fq(Constants.Q, 0), new Fq(Constants.Q, 0)),
            new Fq2(Constants.Q, new Fq(Constants.Q, 0), new Fq(Constants.Q, 0))
        ),
        ["12,2,1"] = new Fq6(
            Constants.Q,
